...
if (isset($_POST['delete'])) {
    ...
    if ($sinavSil->rowCount()) {
        echo '<script> alert("Sınav Silindi") </script><meta http-equiv="refresh" content="1; url=ucSinifSinav.php">';
    } else {
        echo '<script> alert("Hata Oluştu") </script><meta http-equiv="refresh" content="1; url=ucSinifSinav.php">';
    }
}
